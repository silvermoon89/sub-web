...
<script>
const cloudflare = process.env.VUE_APP_CLOUDFLARE;
...
export default {
  data() {
    return {
            ...
            options: [
              {
                label: "Silver",
                value:
                  "https://raw.githubusercontent.com/silvermoon89/clash/refs/heads/main/silver.ini",
              },
              {
              ...
              {
                label: "clash_adg（附带用于 Clash 的 AdGuard DNS）",
                value:
      ...
      form: {
        ...
        clientType: "",
        customBackend:
          this.getUrlParam() == "" ? "https://url.v1.mk" : this.getUrlParam(),
  ...
  methods: {
    ...
    makeUrl() {
      ...
      const host = cloudflare ? cloudflare : backend;
    ...
    getBackendVersion() {
      this.$axios
        ...
        .then((res) => {
          ...
          let a =
            this.form.customBackend.indexOf("url.v1.mk") !== -1 ||
